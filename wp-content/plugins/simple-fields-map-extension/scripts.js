...
var simple_fields_googlemap = (function($) {
	...
	return {
		...
		load_map_script: function() {
			...
			script.src = "https://maps.google.com/maps/api/js?libraries=places&key=AIzaSyBPmFuKltNQP0KAmgWJZH1yyDBMNS4rPMQ&callback=simple_fields_googlemap.map_script_loaded";
